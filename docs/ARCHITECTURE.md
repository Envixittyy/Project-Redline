...
See `docs/LOCAL_COMPANION_ARCHITECTURE.md` for configuration, browser support, threat boundaries, tests, and the precise integration API. This supersedes earlier claims of an unrestricted Phase 9/10 action dispatcher; it does not advance Phase 10B or later phases.
