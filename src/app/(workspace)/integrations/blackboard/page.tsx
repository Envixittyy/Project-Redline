...
export default async function BlackboardPage() {
  if (!isSupabaseConfigured()) return <>
    <PageHeader
      title="Blackboard"
      description="Secure server-side calendar ingestion and notification health."
    />
  ...
  return <>
    <PageHeader
      title="Blackboard"
      description="Secure server-side iCalendar ingestion, source-aware history, and notifications."
    />
    <BlackboardPanel
      status={status}
